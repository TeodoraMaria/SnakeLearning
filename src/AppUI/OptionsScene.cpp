...
void OptionsScene::createScene()
{
    ...
    m_ui->spinBoxQlearningDeepBots->setValue(m_gameSettings.nbQlearningDeepBots);
    m_ui->spinBoxQlearningTabularBots->setValue(m_gameSettings.nbQlearningTabularBots);
