...
AI::Supervised::SupervisedNetwork::SupervisedNetwork(Settings const & settings)
...
AI::Supervised::SupervisedNetwork::SupervisedNetwork(Settings const & settings, std::vector<double> const & weights)
	: m_numInputs(settings.m_numInputs)
	, m_numHidden(settings.m_numHidden)
	, m_numOutputs(settings.m_numOutputs)
{
...
void AI::Supervised::SupervisedNetwork::InitializeWeights()
{
...
void AI::Supervised::SupervisedNetwork::LoadWeights(std::vector<double> const & weights)
{
