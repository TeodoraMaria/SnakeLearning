...
void AI::Supervised::SupervisedTrainer::RunEpoch(TrainingSet const & trainingSet)
{
...
void AI::Supervised::SupervisedTrainer::Backpropagate(std::vector<int32_t> const & expectedOutputs)
{
...
void AI::Supervised::SupervisedTrainer::UpdateWeights()
{
...
void AI::Supervised::SupervisedTrainer::GetSetAccuracyAndMSE(TrainingSet const & trainingSet, double & accuracy, double & MSE) const
{
	accuracy = 0;
	MSE = 0;
